...
const copy = {
  en: {
    ...
    noteCta: "See the steps and limitations", sticksGuide: "Guanyin fortune sticks", compatibilityGuide: "BaZi love compatibility",
  ...
  zh: {
    ...
    noteCta: "查看步骤与使用边界（英文）", sticksGuide: "Guanyin fortune sticks", compatibilityGuide: "BaZi love compatibility", contact: "联系反馈", footer: "从出生意象、自我观察到五行生活灵感。",
    groups: {
