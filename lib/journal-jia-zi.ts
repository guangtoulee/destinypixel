  ...
  "translations": {
      ...
      "sections": [
        {
          ...
          "sources": [
            {
              "label": "Hong Kong Observatory: the stem–branch calendar cycle",
          ...
          "table": {
            ...
            "rows": [
              [
                ...
                "A need to understand the whole situation before committing."
              ],
              [
                "Independent, with high standards",
                "A wish to protect both intellectual freedom and self-respect."
              ],
              [
                "Helpful, but occasionally distant",
                "Plenty of care, expressed through solutions more readily than feelings."
              ],
              [
                "Full of original ideas",
                "Difficulty choosing one possibility and letting the others go."
              ]
            ]
          }
        },
    ...
    "zh": {
      ...
      "sections": [
        ...
        },
        {
          ...
          "table": {
            ...
            "rows": [
              ...
              [
                "热心，却偶尔显得冷淡",
                "很在意对方，但比起表达情绪，更习惯提供解决办法。"
              ],
              [
                "想法多、很有原创性",
                "难的不是再想一个，而是选定一个，放下其他可能。"
              ]
            ]
          }
        },
        {
          "id": "love",
          "title": "3. 感情：先被一个人的脑子吸引",
          "paragraphs": [
            "对甲子这个原型而言，心动常从一句话开始：一个意想不到的问题，一种独立的见解，一场餐厅打烊了还舍不得结束的聊天。你需要欣赏对方，而且这种欣赏得有内容。能认真和你讨论、甚至有理有据地反驳你的人，可能比一味顺着你的人更有吸引力。新鲜感过去之后，彼此还有没有可聊的世界，很重要。",
            "你的喜欢，可能藏在记住对方冷门的爱好、找来一本几个月前提过的书、帮对方理清一个难题里。心底渴望的是「我不用解释那么多，你也懂」。但这种渴望一旦变成考题，就容易委屈两个人：伴侣不该靠猜测你的沉默，才能确认自己被爱；也不该因为没读懂一个从未说出口的期待，就莫名扣分。"
          ]
        },
        {
          "id": "relationship-friction",
          "title": "4. 感情雷点：为什么越在乎，越像一座孤岛？",
          "paragraphs": [
            "一个典型场景：对方说「今天真的很难受」，你立刻开始分析原因、排列方案。你觉得自己在认真帮忙，对方却只想先被抱一下。吵架时也可能如此：你说「让我自己想清楚」，然后退回内心。没有交代何时回来，这段独处在对方那里，就成了一扇关上的门。",
            "更适合这幅画像的关系，是精神上聊得来，日常里也有温度、有回应。独立需要一座桥：「我先缓一个小时，之后我想听你把话说完。」帮忙之前，先问对方需要建议还是陪伴。能尊重你的空间、同时要求稳定联系的人，往往更能让这份聪明变成亲密，而不是两个人各自孤独。"
          ]
        },
        {
          "id": "career",
        ...
        {
          "id": "fortune",
          "title": "7. 运势：什么时候容易迎来转机？",
          "paragraphs": [
            "从甲子这幅画像看，顺起来的时候，往往是思想找到了出口：有人愿意提携，作品开始被看见，或一段关系让你能够坦率表达。卡住的时候，则像水太多、树扎不住根：一直吸收，却很少输出；一直思考，却迟迟不选；明明在乎，却没有让对方感受到。这些是可以对照经历的状态，并不是已经排出的年份预测。",
            "要进一步说「哪年结婚」「几岁收入上台阶」，只看甲子两个字远远不够。传统的时间判断还要结合完整四柱、大运和具体流年。即使在命理内部，也不能因为水生木，就认定水越多越好，要看整体是否需要。完整解读应该把依据和不确定处说清楚，不能给所有甲子日出生的人贴同一个好运日期。"
          ]
        },
        {
          "id": "famous-birthdays",
          "title": "8. 同日柱名人：徐若瑄与宋庆龄",
          "paragraphs": [
            "徐若瑄的看点，不只是「明星和你同日柱」。从电视、电影到音乐，从台湾到日本，她的职业路径跨过不同舞台；官方资料还提到，即使演艺工作繁忙，她依然参与其他歌手的歌词创作。把这段经历放在甲子的创作主题旁边，很容易想到一个问题：当你已经忙于别人交来的工作时，心里是不是还有一些东西，非得由自己写出来才甘心？",
            "宋庆龄呈现的是另一种人生。她长期投入社会福利、妇女与儿童相关工作，关注妇幼健康和儿童教育。把这段公共服务经历放在卡片的知识与责任主题旁边，重点就从「我相信什么」，走到了「我愿意围绕它持续做什么」。这两个人的故事可以拓宽阅读的视角；相同日柱本身，并不能解释她们的性格或成就。"
          ],
          "table": {
            "headings": [
              "人物",
