...
export const reportCopy = {
  en: {
    ...
    accordion: {
      ...
      lifeDimensions: { title: "Life Dimensions", kicker: "Panoramic Fortune" },
    },
    seasons: {
  ...
  zh: {
    ...
    accordion: {
      ...
      lifeDimensions: { title: "全景运势", kicker: "事业感情成长健康" },
    },
    seasons: {
  ...
  ru: {
    ...
    accordion: {
      ...
      lifeDimensions: { title: "Сферы жизни", kicker: "Карьера любовь рост здоровье" },
    },
    seasons: {
