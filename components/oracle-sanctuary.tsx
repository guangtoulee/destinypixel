...
const homeCopy = {
  en: { kicker: "THE ORACLE SANCTUARY", title: "A quiet moment. A question. A sign.", lead: "When you keep circling the same question, pause with a Chinese fortune-stick ritual. Read a verse and its meaning, and notice what it brings to mind about your situation.", stage: "One question at a time", caption: "Pause. Breathe. Let your question settle.", label: "MAKE SPACE FOR CLARITY", invitation: "What’s on your mind?", body: "Try a specific question: “What am I overlooking in this decision?” You will receive a randomly selected stick and its reading, with optional AI interpretation. No birth details needed.", enter: "Draw your first stick", steps: ["Choose a tradition", "Hold a question", "Read your sign"], names: ["Guanyin", "Guandi", "Yuelao", "Wealth Gods", "Wong Tai Sin"], domains: ["Peace & family", "Work & decisions", "Love & connection", "Money & business", "Timing & change"] },
  zh: { kicker: "一念一签 · 求签小殿", title: "把心事放慢，让一支签轻轻回应。", lead: "当一件事在心里绕了很久，不妨先慢下来。带着问题求一支签，读签文与解意，也留意自己被哪句话触动。", stage: "心有所问 · 签有所应", caption: "静心片刻，只为心中这一问。", label: "此刻，你想问些什么？", invitation: "所念之事，慢慢有回响。", body: "比如：“这个决定里，有什么是我还没看见的？”选一处签堂，随机抽取一支签，查看签文与解读，也可选择 AI 解签。不需要出生资料。", enter: "入殿求一签", steps: ["选择签系", "默念心事", "抽签解意"], names: ["观音灵签", "关帝灵签", "月老灵签", "五路财神", "黄大仙签"], domains: ["平安 · 家宅", "事业 · 决断", "姻缘 · 相伴", "财运 · 生意", "时机 · 转折"] },
  "zh-TW": { kicker: "一念一籤 · 求籤小殿", title: "把心事放慢，讓一支籤輕輕回應。", lead: "當一件事在心裡繞了很久，不妨先慢下來。帶著問題求一支籤，讀籤文與解意，也留意自己被哪句話觸動。", stage: "心有所問 · 籤有所應", caption: "靜心片刻，只為心中這一問。", label: "此刻，你想問些什麼？", invitation: "所念之事，慢慢有回響。", body: "比如：「這個決定裡，有什麼是我還沒看見的？」選一處籤堂，隨機抽取一支籤，查看籤文與解讀，也可選擇 AI 解籤。不需要出生資料。", enter: "入殿求一籤", steps: ["選擇籤系", "默念心事", "抽籤解意"], names: ["觀音靈籤", "關帝靈籤", "月老靈籤", "五路財神", "黃大仙籤"], domains: ["平安 · 家宅", "事業 · 決斷", "姻緣 · 相伴", "財運 · 生意", "時機 · 轉折"] },
  ru: { kicker: "ХРАМ ЖРЕБИЕВ", title: "Момент тишины. Вопрос. Знак.", lead: "Если мысли снова возвращаются к одному вопросу, сделайте паузу с китайским храмовым жребием. Прочтите текст и толкование, замечая, что они напоминают о вашей ситуации.", stage: "Один вопрос за раз", caption: "Остановитесь. Вдохните. Подумайте о важном.", label: "ПРОСТРАНСТВО ДЛЯ ЯСНОСТИ", invitation: "Что у вас на душе?", body: "Например: «Что я упускаю в этом решении?» Вы получите случайно выбранный жребий и толкование; разбор ИИ доступен по желанию. Данные рождения не нужны.", enter: "Вытянуть жребий", steps: ["Выберите традицию", "Задайте вопрос", "Прочтите знак"], names: ["Гуаньинь", "Гуаньди", "Юэлао", "Боги богатства", "Вонг Тай Син"], domains: ["Покой и семья", "Работа и решения", "Любовь и близость", "Деньги и бизнес", "Время перемен"] },
};
