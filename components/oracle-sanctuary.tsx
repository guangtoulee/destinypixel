...
const homeCopy = {
  ...
  zh: { kicker: "一念一签 · 求签小殿", title: "把心事放慢，让一支签轻轻回应。", lead: "静下心，想一件挂念的事。从传统签诗里，找一个重新看待它的角度。", stage: "心有所问 · 签有所应", caption: "静心片刻，只为心中这一问。", label: "此刻，你想问些什么？", invitation: "所念之事，慢慢有回响。", body: "是一个决定，一段关系，还是一场新的开始？选择与你心事相合的签，读签诗，也读懂自己的心。", enter: "入殿求一签", steps: ["选择签系", "默念心事", "抽签解意"], names: ["观音灵签", "关帝灵签", "月老灵签", "五路财神", "黄大仙签"], domains: ["平安 · 家宅", "事业 · 决断", "姻缘 · 相伴", "财运 · 生意", "时机 · 转折"] },
  "zh-TW": { kicker: "一念一籤 · 求籤小殿", title: "把心事放慢，讓一支籤輕輕回應。", lead: "靜下心，想一件掛念的事。從傳統籤詩裡，找一個重新看待它的角度。", stage: "心有所問 · 籤有所應", caption: "靜心片刻，只為心中這一問。", label: "此刻，你想問些什麼？", invitation: "所念之事，慢慢有回響。", body: "是一個決定，一段關係，還是一場新的開始？選擇與你心事相合的籤，讀籤詩，也讀懂自己的心。", enter: "入殿求一籤", steps: ["選擇籤系", "默念心事", "抽籤解意"], names: ["觀音靈籤", "關帝靈籤", "月老靈籤", "五路財神", "黃大仙籤"], domains: ["平安 · 家宅", "事業 · 決斷", "姻緣 · 相伴", "財運 · 生意", "時機 · 轉折"] },
