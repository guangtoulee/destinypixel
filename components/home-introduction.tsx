...
const en = {
  ...
  start: "Start with what's on my mind", free: "Explore my birthday card", note: "Three free ways to begin · No account needed",
...
const zh: typeof en = {
  ...
  start: "从我关心的事开始", free: "看看我的生日意象卡", note: "三个免费入口 · 无需注册",
  choose: "此刻，你想多懂一点什么？", chooseLead: "不用先学会玄学术语。带着一个与你有关的问题，选一种适合的探索方式。",
  cards: [
    { title: "更了解自己", question: "为什么一遇到这类事情，我就会这样？", body: "用生日找到六十动物中对应的日柱意象，阅读性格、感情与事业中的不同侧面，再与你真实的经历对照。", input: "只需公历生日", action: "认识我的生日意象", href: "/discover" },
    { title: "更懂彼此", question: "我想要安慰，TA 却一直在讲道理？", body: "结合两人的八字五行与星盘，比较沟通、感情表达和日常节奏。免费查看相处图谱，也找到一个可以一起聊的话题。", input: "双方生日、已知出生时间与城市", action: "看看我们的相处方式", href: "/compatibility" },
    { title: "给心事一个新角度", question: "这个决定里，有什么是我还没看见的？", body: "静下心，为挂念的事求一支签。读签文、看解意，再留意哪句话让你想到自己的处境；也可选择 AI 进一步解读。", input: "一个具体问题 · 不需要出生资料", action: "带着心事求一签", href: "/sticks" },
  ],
...
const ru: typeof en = {
  ...
  start: "Начать со своего вопроса", free: "Моя карточка по дате рождения", note: "Три бесплатных способа начать · Без регистрации",
